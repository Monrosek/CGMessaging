...
@IBDesignable class UserBubbleView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        context?.beginPath()
            ...
            let opposite = currentFrame.size.width
            
            context?.move(to: CGPoint( //13.5,30.5
                x: opposite - (round(currentFrame.size .width / 2 - WidthOfTriangle / 2) + MagicNumber),
                y: HeightOfTriangle + StrokeWidth + MagicNumber))
            context?.addLine(to: CGPoint(
                x: opposite - (BorderRadius + StrokeWidth + MagicNumber + WidthOfTriangle),
                y: HeightOfTriangle + StrokeWidth + MagicNumber))
            context?.addLine(to: CGPoint(//132.5,30.5
                x: opposite - ( BorderRadius + StrokeWidth + MagicNumber),
                y:  StrokeWidth + MagicNumber))
            context?.addLine(to: CGPoint( //13.5,30.5
                x: opposite - (BorderRadius + StrokeWidth + MagicNumber),
